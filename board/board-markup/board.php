...
class SelectData {
	...
	$dbh = new PDO("localhost", "root", "", "animehub.space");
...
echo '<div class="b-threads-list">
      ...
      echo '</div>
            ...
            <div class="b-post-actions clearfix">
                ...
                echo "<a href='/board/$id1->id'"; echo 'class="button-action button-show-thread">Перейти в тред</a>
            </div>
        </div>';
}
...
<div class="page-threads-list">
    <div class="b-top-actions clearfix">
        <a href="/board/add-thread" class="button button-action">Создать новый тред</a>
    </div>
<?php
postThread(0);
postThread(1);

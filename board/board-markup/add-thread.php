...
<div class="page-add-form">
   <form action="../post" class="b-add-thread-form b-big-form" method="post">
        <div class="row">
            <label class="row-label" for="add-title">Заголовок:</label>
            <input type="text" id="add-title" class="input-wide" name="title" value="Проблема с PHP">
        ...
        <div class="row">
            ...
            <textarea id="add-text" class="textarea-wide textarea-large" name="post">Код надо писать не как попало, а аккуратно и красиво. Почему? Потому, что на неакуратно написанный код не хочется даже смотреть.
